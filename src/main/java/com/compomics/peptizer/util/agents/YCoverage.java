...
public class YCoverage extends Agent {
    ...
    public String getDescription() {
        return "<html>Inspects for the matched y-ion coverage of the peptide. <b>Votes 'Positive_for_selection' if the y-ion coverage is equal or less then ( " + ((Double.parseDouble((String) this.iProperties.get(PERCENTAGE)) + 0.0) * 100) + "%)</b>. Votes 'Neutral_for_selection' if better.</html>";
    }
}