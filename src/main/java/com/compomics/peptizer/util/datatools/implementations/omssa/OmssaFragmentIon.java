...
public class OmssaFragmentIon extends PeptizerFragmentIon implements SpectrumAnnotation {
    ...
    public int getNumber() {
        return msMZHit.MSMZHit_number ;
    }

    public IonTypeEnum getType() {
        switch (msMZHit.MSMZHit_ion.MSIonType) {
                // Bion
                case 1 : return IonTypeEnum.b;
                // Yion
                case 4 : return IonTypeEnum.y;
        }
        ...
        switch (msMZHit.MSMZHit_ion.MSIonType) {
            ...
            case 0 : {
                switch (msMZHit.MSMZHit_charge) {
                    case 1 : return new Color(153,0,0);
                    case 2 : return new Color(0,139,0);
                }
            ...
            // C ion
            case 2 : return new Color(188,0,255);
            // X ion
            case 3 : return new Color(78,200,0);
            // Y ion
            case 4 : return new Color(0,0,0);
            // Z ion
            case 5 : {
                switch (msMZHit.MSMZHit_charge) {
                    case 1 : return new Color(255,140,0);
                    case 2 : return new Color(64,179,0);
                }
            ...
            // Unknown ion
            case 9 : return new Color(150,150,150);
        }
