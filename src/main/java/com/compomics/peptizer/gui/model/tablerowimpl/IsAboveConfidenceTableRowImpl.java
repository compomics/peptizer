...
public class IsAboveConfidenceTableRowImpl extends AbstractTableRow {
	// Class specific log4j logger for IsAboveConfidenceTableRowImpl instances.
	 private static Logger logger = Logger.getLogger(IsAboveConfidenceTableRowImpl.class);
