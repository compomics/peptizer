...
public class ModifiedSequenceTableRowImpl extends AbstractTableRow {
	// Class specific log4j logger for ModifiedSequenceTableRowImpl instances.
	 private static Logger logger = Logger.getLogger(ModifiedSequenceTableRowImpl.class);
