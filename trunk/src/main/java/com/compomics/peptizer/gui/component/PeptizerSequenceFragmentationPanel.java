...
public class PeptizerSequenceFragmentationPanel extends JPanel {
     ...
     */
    public PeptizerSequenceFragmentationPanel(String aModifiedSequence, Vector aFragmentIons) throws HeadlessException {
        super();
     ...
     * @see javax.swing.JComponent#getDefaultLocale
     */
    public PeptizerSequenceFragmentationPanel(String aSequence, Vector aFragmentIons, boolean boolModifiedSequence) throws HeadlessException {
        super();
    ...
    private void normalizeMatchedIons() {
        ...
        for (int i = 0; i < iFragmentIons.size(); i++) {
            PeptizerFragmentIon lFragmentIon = (PeptizerFragmentIon) iFragmentIons.elementAt(i);
    ...
    public static void main(String[] args) {
        ...
        final PeptizerSequenceFragmentationPanel jpanImage = new PeptizerSequenceFragmentationPanel(lPeptideHit.getModifiedSequence(), iFragmentIons, false);
