 ...
 */
public class TestBCoverage extends TestCase {
	// Class specific log4j logger for TestBCoverage instances.
	 private static Logger logger = Logger.getLogger(TestBCoverage.class);
