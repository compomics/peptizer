 ...
 */
public class TestDeamidation extends TestCase {
	// Class specific log4j logger for TestDeamidation instances.
	 private static Logger logger = Logger.getLogger(TestDeamidation.class);
